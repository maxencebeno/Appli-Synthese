...
public class AjoutVip extends javax.swing.JDialog {
    ...
    private void gestionDate(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_gestionDate
        ...
        if (dateNaissance.getDocument().getLength() <= 10) { // Si l'utilisateur dépasse 10 caractère on s'arrête
            if (!Character.isDigit(c)) { // On ne peut taper que des chiffress
                evt.consume();
            }
            if (dateNaissance.getDocument().getLength() == 0) {
            ...
            if (dateNaissance.getDocument().getLength() == 1) {
            ...
            if (dateNaissance.getDocument().getLength() == 3) {
                if (c == '1') {
                    verif = true;
                    fevrier = false;
            ...
            if (dateNaissance.getDocument().getLength() == 6) {
        ...
        try {
            if (dateNaissance.getDocument().getLength() == 10) {
                String dateString = dateNaissance.getText() + c;
                Date tempDate;
